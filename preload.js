...
contextBridge.exposeInMainWorld('api', {
  ...
  historySnap: (rel) => ipcRenderer.invoke('history:snap', rel),
  saveAsset: (name, dataUri) => ipcRenderer.invoke('asset:save', { name, dataUri }),
  readAsset: (rel) => ipcRenderer.invoke('asset:read', rel),
  pruneAssets: () => ipcRenderer.invoke('asset:prune'),
  updateCheck: () => ipcRenderer.invoke('update:check'),
  updateRun: () => ipcRenderer.invoke('update:run'),
  updateRelaunch: () => ipcRenderer.invoke('update:relaunch'),
  updateOpenLog: () => ipcRenderer.invoke('update:openlog'),
  onUpdateProgress: (cb) => ipcRenderer.on('update:progress', (e, m) => cb(m)),
